...
public class LoginPage extends BasePage {
	...
	public void assignValueAndLogin(String user, String pwd, String Role) throws InterruptedException {
	    WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(20));
	    
	    WebElement userNameTextBox = wait.until(ExpectedConditions.visibilityOfElementLocated(By.id("username")));
	    System.out.println("Is username field displayed? " + userNameTextBox.isDisplayed());
	    System.out.println("Is username field enabled? " + userNameTextBox.isEnabled());

	    if (user == null || user.isEmpty()) {
	        System.out.println("Username from Excel is empty!");
	    } else {
	        System.out.println("Username to be entered: " + user);
	        userNameTextBox.click(); // Click before entering text
	    ...
	    switch (Role) {
	        case "Admin":
	            ...
	            break;
	        case "Student":
	            selectStudentRole.click();
	            break;
	        case "Staff":
	            selectStaffRole.click();
	            break;
	        default:
	            System.out.println("No such Roles available....");
	    }
	    justClick();
	    loginBtn.click();
	}
